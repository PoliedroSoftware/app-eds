...
public partial class CustomAlert : Popup
{
    ...
    public static async Task ShowInfoAsync(string message, string title = "Informaci�n")
    {
        var alert = new CustomAlert(title, message, "OK", null, AlertType.Info);
        await alert.ShowAsync();
    }

    public static async Task ShowSuccessAsync(string message, string title = "�xito")
    {
        var alert = new CustomAlert(title, message, "OK", null, AlertType.Success);
        await alert.ShowAsync();
    }

    public static async Task<bool> ShowConfirmAsync(string message, string title = "Confirmar", string confirmText = "S�", string cancelText = "No")
    {
